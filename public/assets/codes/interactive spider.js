// Place this file in src/assets/codes/interactive-spider.js

export default function initSpiderEffect() {
    let w, h;
    ...
    function animate(t) {
      ...
      // Adjust the background and drawing colors as needed
      ctx.fillStyle = 'rgba(0, 0, 0, 0)'; // Transparent background
      ctx.fillRect(0, 0, w, h);
  
      ctx.fillStyle = ctx.strokeStyle = "#D4B051"; // Set drawing color to black
      t /= 1000;
